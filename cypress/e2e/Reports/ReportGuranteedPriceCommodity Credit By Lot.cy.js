...
describe("Reports Module", () => {
    ...
    it("Report > Guaranteed Price Setup > Commodity Credit By Lot", () => {
        ...
        cy.get('#Item_JHS228').trigger('mouseover')
        cy.get('#Item_JHS230').trigger('mouseover').click()
        cy.wait(6000)

        
        cy.get('#ctl00_ctl00_ContentPlaceHolder_RightSectionPlaceHolder_ReportViewer1_ctl04_ctl04 > .ui-datepicker-trigger').click()        // cy.get('.ui-datepicker-prev > .ui-icon').click()
        ...
        // cy.contains('21042025').should('be.visible')
        // cy.contains('Corn').should('be.visible')
        // cy.contains('4/21/2025').should('be.visible')
        ...
        // // Check Contract Number after removing 'KS'
        // cy.get('#txtContractNum')
        //     .should('be.visible')
        //     .invoke('val')
        //     .then((contractNum) => {
        //         const cleanedValue = contractNum.replace(/^KS/, '').trim(); // Remove 'KS' from start
        //         expect(cleanedValue).to.equal('21042025');
        //     });
        ...
        // // Check Contract Date value for input field
        // cy.get('#txtContractDate')
        //     .should('be.visible')
        //     .invoke('val')
        //     .then((dateValue) => {
        //         expect(dateValue.trim()).to.equal('04/21/2025');
        //     });
